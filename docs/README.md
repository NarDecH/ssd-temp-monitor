...
แท็บ Health มีปุ่ม **รายงานรายสัปดาห์** (เปิดในเบราว์เซอร์ทันที) และ
**ส่งออก...** (เลือกที่เซฟเองด้วย Save As) — ไฟล์ HTML ไฟล์เดียวจบ
ไม่พึ่งเน็ต ส่งต่อ/แนบเมลได้ พร้อม **กราฟ 3 ชุดต่อดิสก์**: อุณหภูมิเฉลี่ยรายวัน /
การสึก (wear %) / uncorrected read errors (ตัดที่ 500) ข้อมูลมาจาก
`health_daily.csv` ที่แอปบันทึกวันละหนึ่งแถวต่อดิสก์อัตโนมัติ
